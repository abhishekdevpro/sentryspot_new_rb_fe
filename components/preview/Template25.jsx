      ...
      <div className="max-w-3xl mx-auto p-5 bg-amber-50 shadow-md border-solid border-2 border-black mb-5 rounded-lg">
        ...
        <div class="flex gap-2 items-start ">
          <div class="w-2/3 text-left">
            <h1
              className="text-8xl text-black font-bold uppercase mb-4"
            ...
            <div className="mb-8 pt-2.5	flex justify-between">
              <h1
                className="text-2xl text-black font-light mb-4"
                style={{ color: headerColor }}
              >
                {resumeData.name}
              </h1>
              <h2
                className="text-2xl text-black tracking-wide uppercase font-light mb-4"
                style={{ color: headerColor }}
              >
                {resumeData.position}
              </h2>
        ...
        <div class="flex gap-2 items-start justify-between">
          ...
          <div class="p-5 w-1/2">
            ...
            <div class=" text-left">
              <h2 class="text-xl font-bold uppercase text-black mb-5">
                Reference
              </h2>
              <div class="">
                <div class="mb-5">
                  <p class="text-l font-semibold mb-2 uppercase text-black">
                    Estelle Darcy
                  </p>
        ...
        <div className="mb-8 pt-2.5 ">
          <h1
            className="text-7xl text-center text-black font-bold mb-4"
            style={{ color: headerColor }}
          >
            {resumeData.name}
          </h1>
