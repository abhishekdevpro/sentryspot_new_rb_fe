    ...
    <div className="max-w-4xl mx-auto bg-white p-8 border border-gray-200 rounded-lg shadow-lg">
      <div className="container mx-auto flex bg-white shadow-lg">
        ...
        <div className="left-column w-8/12 p-8 border-r border-gray-300">
          <h3
            className="text-4xm text-orange-600 mb-2"
          ...
          <h3
            className="text-xl text-orange-600 mt-10 mb-2"
            style={{ color: headerColor }}
          >
            WORK EXPERIENCE
          </h3>
                          ...
                          {(provided, snapshot) => (
                            ...
                            >
                              <div className="flex flex-row justify-between space-y-1">
                                <p className="content i-bold leading-normal">
                                  {item.company}
                                </p>
                                <DateRange
                              ...
                              <p
                                className="content hyphens-auto leading-loose"
        ...
        >
          <div className="contact mb-8">
            <h3
              className="text-xl text-orange-600 mb-2"
              style={{ color: headerColor }}
            >
              CONTACT
            </h3>
          ...
          <div className="skills mb-8">
                    ...
                    >
                      {(provided, snapshot) => (
                        <li
                          ...
                          {...provided.draggableProps}
                          {...provided.dragHandleProps}
                          className={` hover:scale-105 transition-transform duration-300 text-sm mb-1.5 ${
                            snapshot.isDragging &&
                            "outline-dashed outline-2 outline-gray-400 bg-white"
                          }`}
                        >
            ...
            <p
              className="text-gray-700 mt-4 text-orange-600"
              style={{ color: headerColor }}
            >
              Languages:
            </p>
          ...
          <div className="education mb-8">
            {resumeData.education.length > 0 && (
              <div className="mb-1">
                <h2
                  className="section-title mb-1 border-b-2 border-gray-300 text-orange-600"
                  style={{ color: headerColor }}
                >
                  Education
                </h2>
