      ...
      <div className="max-w-3xl mx-auto p-5 bg-white-500 shadow-md">
        <div class="flex gap-1 items-start">
          <div class="bg-gray-900 w-1/3 p-5 h-full">
            ...
            <div class="text-left text-[#003479]">
              <div className="mb-8">
                <h2
                ...
                <ContactInfo
                  mainclass=" gap-1 mb-1 text-[#003479] mb-5 contact"
            ...
            <div className="mb-8">
              <h2
                className="text-xl text-[#003479] mb-5 font-bold mb-4"
                style={{ color: headerColor }}
              >
                EDUCATION
              </h2>
                  ...
                  {resumeData.education.length > 0 && (
                    <div className="mb-5">
                      {resumeData.education.map((item, index) => (
                        <div key={index} className="text-[#003479] mb-5">
                          <p
            ...
            <div className="mb-8">
              <h2
                className="text-xl font-bold text-[#003479] mb-4"
                style={{ color: headerColor }}
              >
                SKILLS
              </h2>
                      ...
                      >
                        {(provided, snapshot) => (
                          <div
                            ...
                            className={`text-[#003479] mb-5 hover:scale-105 transition-transform duration-300 mb-1 ${
                              snapshot.isDragging &&
            ...
            <div className="mb-8">
              <h2
                className="text-xl font-bold text-[#003479]"
                style={{ color: headerColor }}
              >
                LANGUAGE
              </h2>
              <div className="flex text-[#003479] justify-start mb-4 font-bold">
