  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 border border-gray-200 rounded-lg shadow-lg">
      <div className="header text-center mb-6">
        ...
        <h1 className="text-2xl mb-1.5" style={{ color: headerColor }}>
          {resumeData.name}
        </h1>
      ...
      <section className="experience mb-6">
        <h2
          className="text-lm mb-2.5 uppercase border-b border-black pb-0.5 fw-bold"
      ...
      <section className="skills mb-6">
        <h2
          className="text-lg mb-2.5 uppercase border-b border-black pb-0.5"
          style={{ color: headerColor }}
        >
          Skills
        </h2>
