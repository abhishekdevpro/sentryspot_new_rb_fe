...
const Template14 = () => {
    ...
    />
                      ...
                      <div className="mb-1">
                        {resumeData.education.map((item, index) => (
                          <div  key={index} className="mb-1 text-lg">
                            <p className="font-bold text-lg " style={{ fontSize: '1.3rem' }}>{item.degree}</p>
                              ...
                              {(provided, snapshot) => (
                                ...
                                >
                                  <div className="justify-between space-y-1">
                                    <p className="font-bold text-lg" style={{ fontSize: '1.3rem' }}>{item.company}</p>
                                    <DateRange
                                      startYear={item.startYear}
                                      endYear={item.endYear}
                  ...
                  {resumeData.projects.length > 0 && (
                    <Droppable droppableId="projects" type="PROJECTS">
                      {(provided) => (
                        <div {...provided.droppableProps} ref={provided.innerRef}>
                          <h2
                            className="font-bold text-lg mb-1 border-b-2 border-gray-300 editable"
                            contentEditable
          ...
          <div className="mb-5">
            ...
            <h3 className="text-xl font-semibold border-b-2 border-gray-800 pb-2 mb-4 mt-4" style={{ color: headerColor }}>Certifications</h3>
                  <Certification
