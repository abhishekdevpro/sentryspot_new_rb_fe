...
//             <div className="mb-8">
//               <h2
//                 className="text-xl text-black font-bold mb-4 bg-yellow-600 h-1/5 	 bg-cover"
...
//           <div className="mb-8">
//             <h2
//               className="text-xl text-black mb-5 font-bold mb-4 bg-yellow-600 h-1/5	 bg-cover"
//               style={{ color: headerColor }}
//             >
//               EDUCATION
//             </h2>
...
//           <div className="mb-8">
//             <h2
//               className="text-xl font-bold text-black mb-4 bg-yellow-600 h-1/5	 bg-cover"
//               style={{ color: headerColor }}
//             >
//               SKILLS
//             </h2>
...
//           <div className="mb-8">
//             <h2
//               className="text-xl font-bold text-black bg-yellow-600 h-1/5 	 bg-cover"
//               style={{ color: headerColor }}
//             >
//               LANGUAGE
//             </h2>
  ...
  return (
    <div ref={templateRef} className="max-w-4xl mx-auto p-2 bg-white shadow-md min-h-screen">
      <div className="flex gap-1 items-stretch w-full">
        <div className=" text-black w-1/3 p-5 h-full">
          <div className="mb-5">
            <Image
              src={resumeData.profilePicture}
              alt="profile"
          ...
          <div className="text-left">
            <div className="mb-8">
              <h2 className="text-xl text-black font-bold mb-4 bg-yellow-600" style={{ color: headerColor }}>
                CONTACT
              </h2>
    ...
    />
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold text-black mb-4 bg-yellow-600" style={{ color: headerColor }}>
              SKILLS
            </h2>
            <Droppable droppableId="skills" type="SKILLS">
              {(provided) => (
        ...
        <div className="p-5 w-2/3">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-4" style={{ color: headerColor }}>
              {resumeData.name}
            </h1>
            <h2 className="text-2xl font-semibold mb-3" style={{ color: headerColor }}>
              {resumeData.position}
            </h2>
          </div>
          ...
          <div className="mb-8">
            ...
            <div>
              <h3 className="text-xl font-semibold border-b-2 border-gray-800 pb-2 mb-4" style={{ color: headerColor }}>
                Projects
              </h3>
                          ...
                          {(provided, snapshot) => (
                            ...
                            >
                              ...
                              <p
                                contentEditable="true"
                                suppressContentEditableWarning={true}
                                className="hyphens-auto hover:outline-dashed hover:outline-2 hover:outline-gray-400"
                              >
                                {item.description}
                              </p>
                              <Droppable
