      ...
      />
            ...
            {/* {resumeData.languages.length > 0 && (
              <div>
                ...
                <p className="sub-content border-l-4 border-l-gray-800 p-2 bg-stone-200 my-2">
                  ...
                  itemClassNames={{
                    language: "sub-content border-l-4 border-l-gray-800 p-2 bg-stone-200 my-2", 
                   title:"section-title mb-1 border-b-2 border-gray-300"
                  }}
                  title="Languages" languages={resumeData.languages} />
            {resumeData.certifications.length > 0 && (
              <div>
                <h2
                  className="section-title mb-1 border-b-2 border-gray-300"
          ...
          className="hover:scale-105 transition-transform duration-300 mb-1 border-l-4 border-l-gray-800 p-2 bg-stone-200 my-2"
                   itemClassNames={{
                    ...
                    position:"content",
                    location:"sub-content",
                     content:"hover:scale-105 transition-transform duration-300 mb-1 border-l-4 border-l-gray-800 p-2 bg-stone-200 my-2"
                   
                  }} resumeData={resumeData} headerColor={headerColor} />
