...
function Careers() {
    return (
      <div className="m-10 mx-40 p-5  shadow-2xl">
        <h1 className="text-4xl font-semibold my-4 underline ">Careers at </h1>
        ...
        who share our vision and dedication.
        ...
        At SentrySpot, we believe in the power of collaboration. Our team
        ...
        Your work at SentrySpot will have a direct impact on our clients’ lives.
        ...
        seasoned professional or just starting out, we provide a clear path for
        your career progression.
        <h1 className="text-2xl font-semibold my-2 mt-5 underline">
          Current Openings
        </h1>
        <h1 className="text-2xl font-semibold my-2 mt-5">Resume Writer</h1>
        Join our team of expert resume writers and help clients create standout
        resumes. You’ll work closely with job seekers to understand their career
        goals and craft resumes that highlight their strengths and achievements.
        ...
        client has a positive experience with SentrySpot.
        ...
        for a position at SentrySpot, please send your resume and a cover letter
        to [career@SentrySpot.ca](mailto:career@SentrySpot.ca).
        <h1 className="text-2xl font-semibold my-2 mt-5">
