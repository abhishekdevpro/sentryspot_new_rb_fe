...
function PrivacyPolicy() {
    return (
      <div className="m-10 mx-40 p-5  shadow-2xl">
        ...
        At SentrySpot, we value your privacy and are committed to protecting
        ...
        safety of SentrySpot, our clients, or others.
        ...
        [career@SentrySpot.ca](mailto:career@SentrySpot.ca)
      </div>
    );
}
