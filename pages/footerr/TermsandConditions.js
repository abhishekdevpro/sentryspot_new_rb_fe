...
- All content, materials, and services provided by SentrySpot are protected by intellectual property laws.
...
- SentrySpot respects the privacy and confidentiality of its clients.
...
- SentrySpot will not be liable for any direct, indirect, incidental, or consequential damages arising out of or in connection with the use of our services.
...
- Our services are provided on an "as is" and "as available" basis. SentrySpot makes no warranties, express or implied, regarding the accuracy, reliability, or completeness of our services.
...
- SentrySpot reserves the right to modify or update these terms and conditions at any time without prior notice.
...
- These terms and conditions are governed by and construed in accordance with the laws of the jurisdiction in which SentrySpot operates.
...
Email [career@SentrySpot.ca](mailto:career@SentrySpot.ca)  
---

These terms and conditions are designed to ensure a clear understanding of our services and the responsibilities of both SentrySpot and our clients. If you need any additional details or specific clauses included, please let me know! */}
      </div>
    );
}
