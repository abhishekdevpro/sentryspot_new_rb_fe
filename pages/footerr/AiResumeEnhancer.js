...
function AiResumeEnhancer() {
    return (
      <div className="m-10 mx-40 p-5  shadow-2xl">
        ...
        At SentrySpot, we believe that every job seeker deserves a standout
        ...
        Upload your existing resume to the SentrySpot platform. Our AI will
        start analyzing your document immediately.
        ...
        Transform your resume with SentrySpot’s AI Resume Enhancer. Sign up now
