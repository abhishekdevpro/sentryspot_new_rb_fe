...
import logo from "../Footer/sentryspot-logo.png";
...
const Footer = () => {
  ...
  return (
    <>
      <ToastContainer />
      <footer className="bg-black text-[#003479] py-8" id="footerbg">
        <div className="container mx-auto flex flex-col gap-7 justify-between px-6">
          <div className="flex flex-wrap justify-between px-2 md:px-[65px]">
            ...
            <div className="w-full md:w-auto mb-6 md:mb-0">
              <h2 className="text-lg font-semibold text-[#003479]">
                Get Our Weekly
              </h2>
              <form
          ...
          <div className="flex flex-wrap justify-around">
            <div className="w-full md:w-auto mb-6 md:mb-0" id="footer">
              <h2 className="text-lg font-bold text-[#003479]">SentrySpot</h2>
              <ul>
                <li>
                ...
                <li>
                  <Link href="https://www.ResumeIntellect.ca/blog/">
                    <span>Resources</span>
                  </Link>
                </li>
              </ul>
            ...
            <div className="w-full md:w-auto mb-6 md:mb-0">
              <h2 className="text-lg font-bold text-[#003479]">Support</h2>
              <ul>
                <li>
            ...
            <div className="w-full md:w-auto mb-6 md:mb-0">
              <h2 className="text-lg font-bold text-[#003479]">
                Scope & Products
              </h2>
              <ul>
                <li>
            ...
            <div className="w-full md:w-auto mb-6 md:mb-0">
              <h2 className="text-lg font-bold text-[#003479]">Ai Resources</h2>
              <ul>
                <li>
        ...
        <div className="container text-base md:mx-auto text-center border-t border-white pt-6 mt-6">
          <p className="text-[#003479] text-right">
