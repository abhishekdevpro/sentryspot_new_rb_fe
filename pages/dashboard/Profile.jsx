...
//    <>
//    <Navbar/>
//     <div className="bg-[#003479] p-4">
//       <div className="max-w-4xl mx-auto">
//         <div className="rounded-lg shadow-lg p-6 bg-[#003479] flex flex-col md:flex-row justify-between items-center md:h-44">
...
//               <div>
//                 <p className="text-[#fff]">📧 {formData.email || "Please update your [Email]"}</p>
//                 <p className="text-[#fff]">📱 {formData.phone || "Please update your [Phone]"}</p>
...
//                 <button
//                   className="bg-black text-[#fff] px-6 py-2 rounded-lg hover:bg-gray-800 w-full md:w-auto"
//                   onClick={() => handleGetScore(resumes[0])}
//                 >
//                   {isLoading ? (
//                     <span className="flex items-center justify-center">
//                       <svg className="animate-spin h-5 w-5 mr-3 text-[#fff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
//                 disabled
//               />
//               <span className="text-[#fff] ml-2">{selectedFile ? selectedFile.name : `Upload .Pdf `}</span>
//             </div>
//             <Link href="/dashboard/ai-resume-builder">
//               <button
//                 className="bg-blue-500 text-[#fff] px-1 py-2 rounded-lg hover:bg-blue-600 w-full md:w-auto"
//           >
//             Upload Resume
//           </button>
//         </Link>
...
//         <div className="bg-gray-700 p-10 rounded shadow-lg text-[#fff]">
//           <h2 className="text-xl font-semibold text-[#fff]">Resume Score</h2>
//           <p><strong>Content Accuracy Percentage: </strong> {modalContent}</p>
//           <div className="flex mt-4">
//             <button
//               onClick={copyToClipboard}
//               className="bg-blue-500 text-[#fff] py-1 px-4 rounded mr-2"
//             >
//               Copy
//             </button>
//             <button
//               onClick={() => setIsModalOpen(false)}
//               className="bg-yellow-500 text-[#fff] py-1 px-4 rounded"
//             >
//               Close
//             </button>
//           </div>
...
//         <p className="text-sm text-[#fff] font-semibold">{uploadStatus}</p>
//       </div>
//     )}
//   </div>
// </div></>
...
const ProfilePage = () => {
  ...
  const fetchResumes = async () => {
    ...
    try {
      ...
      if (response.data && Array.isArray(response.data.resumelist)) {
        const resumes = response.data.resumelist;
        if (resumes.length === 0) {
          toast.info("No resumes available.");
        }
    ...
    <>
      ...
      <div className="bg-[#fff] p-4">
        <div className="max-w-4xl mx-auto">
          <div className="rounded-lg shadow-lg p-6 bg-[#003479] flex flex-col md:flex-row justify-between items-center md:h-44">
            <div className="space-y-4 mb-6 md:mb-0 md:mr-6 md:pr-6 w-full">
              <div className="flex flex-col md:flex-row md:items-center md:space-x-4 text-white">
                <img
                  src={
            ...
            <div className="flex flex-col justify-start items-start gap-3 mx-1 w-full md:w-auto">
                ...
                >
                  ...
                  >
                    {isLoading ? (
                      <span className="flex items-center justify-center">
                        <svg
                          className="animate-spin h-5 w-5 mr-3 text-[#fff]"
              ...
              <div className="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto">
                ...
                <label
                  htmlFor="fileInput"
                  className="bg-[#e60278] text-[#fff] px-4 py-2 rounded-lg hover:bg-pink-500 cursor-pointer w-full md:w-auto text-center"
                >
                  {isLoading ? (
                    <span className="flex items-center justify-center">
                      <svg
                ...
                {selectedFile && (
                  <span className="text-[#fff] ml-2 truncate max-w-xs">
                    {selectedFile.name}
                  </span>
                )}
              </div>
            ...
            <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50">
              <div className="bg-gray-700 p-10 rounded shadow-lg text-[#fff]">
                ...
                <div className="flex mt-4">
                  <button
                    onClick={copyToClipboard}
                    className="bg-blue-500 text-[#fff] py-1 px-4 rounded mr-2 hover:bg-blue-600"
                  >
                    Copy
                  </button>
                  <button
                    onClick={() => setIsModalOpen(false)}
                    className="bg-yellow-500 text-[#fff] py-1 px-4 rounded hover:bg-yellow-600"
                  >
                    Close
                  </button>
                </div>
