...
//         <div className=' flex flex-col gap-2 justify-evenly md:flex-row rounded-xl  px-5 text-[#003479] ' >
...
//           <h1 className=' text-center font-bold text-4xl py-2  text-[#003479]'>How Our AI Resume Works For You</h1>
//                  <div>
//                     <div className='flex items-center hover:border-b-2 shadow-lg rounded-2xl py-2 shadow-gray-600 px-3 hover:border-slate-500 hover:rounded-lg  gap-2 text-[#003479]'>
//                         <div>
...
//       <div><i className="fa-solid fa-check border-2 px-3 py-1 rounded-full text-[#003479] bg-green-500 "></i>Chosen & Crafted by Our Experts</div>
//       <div><i className="fa-solid fa-check border-2 px-3 py-1 rounded-full text-[#003479] bg-green-500 "></i>Backed by our Technology</div>
//     </div>

//     <div className=' text-lg text-left flex flex-col gap-4 '>      
//       <div><i className="fa-solid fa-check border-2 px-3 py-1 rounded-full text-[#003479] bg-green-500 "></i> Powered by our Robust AI </div>
//        <div><i className="fa-solid fa-check border-2 px-3 py-1 rounded-full text-[#003479] bg-green-500 "></i> Get it ready in less than 15 minutes</div>
//     </div>
//     </div>
//   </div>
...
//         <button className='absolute top-0 left-0 right-0 bottom-0 m-auto w-fit h-fit  text-[#003479] bg-white font-bold py-2 px-4 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300' id='home_third'>Build Your Resume Now</button>
//       </Link></div>
//     ))}
//   </div>
// </div>
...
//                     <h1 className='font-bold text-xl text-center mt-2' id='homecard'>{template.title}</h1>
//                     <Link href="/dashboard/profile">
//                         <button className='absolute top-0 left-0 right-0 bottom-0 m-auto w-fit h-fit bg-blue-600 text-[#003479] font-bold py-2 px-4 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300' id='home_third'>
//                             Create Your Resume
//                         </button>
//                     </Link>
//                 </div>
...
//         <h1 className='font-bold  text-xl text-center mt-2' id='homecard'>{template.title}</h1>
//         <Link href="/dashboard/profile">
//         <button className='absolute top-0 left-0 right-0 bottom-0 m-auto w-fit h-fit bg-blue-600 text-[#003479] font-bold py-2 px-4 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300' id='home_third'>Create Your CV </button>
//         </Link> </div>
//     ))}
//   </div>
// </div>
...
function Home_third() {
  return (
    <>
      <div className='bg-white py-10 mb-3'>
        <div className='flex justify-center'>
          <div className='md:w-[78%] rounded-xl py-5 px-4' id='home_third'>
            <div className='flex flex-col gap-2 justify-evenly md:flex-row rounded-xl px-5 text-[#003479]'>
              <div>
        ...
        <div className='flex flex-col gap-5 my-8 rounded-xl justify-center px-5 py-10 shadow-gray-600'>
          <div className='flex flex-col items-center'>
            <h1 className='text-3xl font-bold text-center py-6 text-[#003479]'>Explore Our Wide Range Of Trending Templates That Recruiters Love To See</h1>
            <div className='flex gap-2'>
              <div className='text-md text-left flex flex-col gap-4 text-[#545353]'>
                <div><TickIcon /> Chosen & Crafted by Our Experts</div>
                <div><TickIcon /> Backed by our Technology</div>
              </div>
              <div className='text-lg text-left flex flex-col gap-4 text-[#545353]'>
        ...
        <div className='flex flex-col gap-5 px-9 py-7 rounded-xl md:mx-auto'>
          <div className='flex flex-col items-center max-w-7xl mx-auto text-center'>
            <h1 className='text-3xl font-bold text-center py-6 text-[#003479]'>Make Your Resume Using Real-World Examples</h1>
        ...
        <div className='flex flex-col gap-5 px-5 py-10'>
          <div className='flex flex-col items-center'>
            <h1 className='text-3xl font-bold text-center py-6 text-[#003479]'>Looking For Impressive Cover Letters?</h1>
